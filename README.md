/**
* @name arcaea theme for discord
* @author rafaadytianugraha
* @version 3.2
* @description An easily customizable and automatically updating theme
* @invite FdZhbjY
* @source https://github.com/rafaadytianugraha
...
:root {
  /*
    Theme Background
  */
  --theme-background-image: url(https://cdn.discordapp.com/attachments/1113810695717400697/1131885843582291998/STFU_2.jpg);
  ...
  */
  --theme-transparency: rgba(0, 0, 0, 0.2);

  /*
    Home Icon Image
  */
  --home-icon-image: url(https://static-wikia-nocookie-net.translate.goog/iowiro/images/1/14/Partner_55.png/revision/latest?cb=20220707024518&_x_tr_sl=en&_x_tr_tl=id&_x_tr_hl=id&_x_tr_pto=tc);
  ...
  */
  ...
  --big-user-popout-background-transparency: rgba(0, 0, 0, 0.4);
  --big-user-popout-background-image-position: center;

  /*
    Code Markup
  */
  --code-markup-background-color: rgba(0, 0, 0, 0.4);
